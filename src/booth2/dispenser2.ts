 ...
 *
 */
export function createDispenser2(
  ...
  async function makeTransaction() {
    ...
    if (+createdTime > +new Date() - timeDelay) {
      PlayCloseSound()
      boothUI.timerBeforeClaim2(createdTime, timeDelay)
      return
    }
    ...
    try {
      ...
      const captchaResult = await boothUI.captcha2(serverURL, captchaUUID)
