...
import { PlayCloseSound, PlayCoinSound } from './sounds2'

export function timerBeforeClaim2(createdTime: Date, delay: number) {
...
export async function captcha2(
  serverURL: string,
  captchaUUID: string
...
export function alreadyClaimed2() {
...
export function viewSuccessMessage2(
  poapName: string,
  image: string,
  imageSizeX: number,
  imageSizeY: number
