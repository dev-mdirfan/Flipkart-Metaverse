...
import { PlayCloseSound3, PlayCoinSound3 } from './sounds3'
...
export async function captcha3(
  serverURL: string,
  captchaUUID: string
...
export function alreadyClaimed3() {
...
export function viewSuccessMessage3(
  poapName: string,
  image: string,
  imageSizeX: number,
  imageSizeY: number
