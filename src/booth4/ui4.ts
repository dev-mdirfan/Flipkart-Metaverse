...
import { PlayCloseSound4, PlayCoinSound4 } from './sounds4'

export function timerBeforeClaim4(createdTime: Date, delay: number) {
...
export async function captcha4(
  serverURL: string,
  captchaUUID: string
...
export function alreadyClaimed4() {
...
export function viewSuccessMessage4(
  poapName: string,
  image: string,
  imageSizeX: number,
  imageSizeY: number
